...
- **[12] DiTFastAttn: Attention Compression for Diffusion Transformer Models**, NeurIPS 2024  
  *Zhihang Yuan, Hanling Zhang, Pu Lu, Xuefei Ning, Linfeng Zhang, Tianchen Zhao, Shengen Yan, Guohao Dai, Yu Wang*  
  [[Paper](https://arxiv.org/abs/2406.08552)] [Code]  
  ![](https://img.shields.io/badge/DiTFastAttn-blue) ![](https://img.shields.io/badge/Image_Generation-green) ![](https://img.shields.io/badge/Attention_Compression-orange)

- **[13] DiffRate: Differentiable Compression Rate for Efficient Vision Transformers**, ICCV 2023  
  *Mengzhao Chen, Wenqi Shao, Peng Xu, Mingbao Lin, Kaipeng Zhang, Fei Chao, Rongrong Ji, Yu Qiao, Ping Luo*  
  [[Paper](https://arxiv.org/abs/2305.17997)] [[Code](https://github.com/OpenGVLab/DiffRate)]  
  ![](https://img.shields.io/badge/DiffRate-blue) ![](https://img.shields.io/badge/Image_Generation-green) ![](https://img.shields.io/badge/Token_Compression-orange)

- **[14] DeepCache: Accelerating Diffusion Models for Free**, CVPR 2024  
  *Xinyin Ma, Gongfan Fang, Xinchao Wang*  
  [[Paper](https://arxiv.org/abs/2312.00858)] [[Code]https://github.com/horseee/DeepCache]
  ![](https://img.shields.io/badge/DeepCache-blue) ![](https://img.shields.io/badge/Image_Generation-green) ![](https://img.shields.io/badge/Cache_Mechanism-orange)

- **[15] FORA: Fast-Forward Caching in Diffusion Transformer Acceleration**, arXiv 2024  
  *Pratheba Selvaraju, Tianyu Ding, Tianyi Chen, Ilya Zharkov, Luming Liang*  
  [[Paper](https://arxiv.org/abs/2407.01425)] [[Code]https://github.com/prathebaselva/FORA]  
  ![](https://img.shields.io/badge/FORA-blue) ![](https://img.shields.io/badge/Image_Generation-green) ![](https://img.shields.io/badge/Cache_Mechanism-orange)

- **[16] ENAT: Rethinking Spatial-Temporal Interactions in Token-based Image Synthesis**, NeurIPS 2024  
  *Zanlin Ni, Yulin Wang, Renping Zhou, Yizeng Han, Jiayi Guo, Zhiyuan Liu, Yuan Yao, Gao Huang*  
  [[Paper](https://arxiv.org/abs/2411.06959)] [[Code] https://github.com/LeapLabTHU/ENAT] 
  ![](https://img.shields.io/badge/ENAT-blue) ![](https://img.shields.io/badge/Image_Synthesis-green) ![](https://img.shields.io/badge/Token_Interaction-orange)

- **[17] LinFusion: 1 GPU, 1 Minute, 16K Image**, arXiv 2024  
  *Songhua Liu, Weihao Yu, Zhenxiong Tan, and Xinchao Wang∗*  
  [[Paper](https://arxiv.org/abs/2409.02097)] [Code]  
  ![](https://img.shields.io/badge/LinFusion-blue) ![](https://img.shields.io/badge/High_Resolution-green) ![](https://img.shields.io/badge/Efficiency-orange)
...
- **[18] ImageFolder: Autoregressive Image Generation with Folded Tokens**, arXiv 2024  
  *Xiang Li, Kai Qiu, Hao Chen, Jason Kuen, Jiuxiang Gu, Bhiksha Raj, Zhe Lin*  
  [[Paper](https://arxiv.org/abs/2410.01756)] [[Code]  https://github.com/lxa9867/ImageFolder]
  ![](https://img.shields.io/badge/ImageFolder-blue) ![](https://img.shields.io/badge/Image_Generation-green) ![](https://img.shields.io/badge/Token_Folding-orange)

- **[19] FRDiff: Feature Reuse for Universal Training-Free Acceleration of Diffusion Models**, ECCV 2024  
  *Junhyuk So, Jungwon Lee, Eunhyeok Park*  
  [[Paper](https://arxiv.org/abs/2312.03517)] [Code]  
  ![](https://img.shields.io/badge/FRDiff-blue) ![](https://img.shields.io/badge/Image_Generation-green) ![](https://img.shields.io/badge/Feature_Reuse-orange)
